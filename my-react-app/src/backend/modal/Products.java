...
public class Products {
    ...
    public Products(int productId, String productName, String productDescription, double productPrice, int productStock, Date productCreateAt, String productNote, String productUnit, int productDiscount, String productImageLink, int categoriesID) {
